...
class Class_Payment_Socket_Alipay
{
    ...
    public function __construct()
    {
    	 ...
    	 * 
    	 * 2088002005537370
		 * jkjsy7tty6cgo89etq4szovnp7e8jt54
    	 * 
    	 * 
    	 ...
    	 * @var unknown_type
    	 */
        $this->_securityCode = 'jkjsy7tty6cgo89etq4szovnp7e8jt54';
        
        $this->_partner = '2088002005537370';
        $this->_sellerEmail = 'craftgavin@gmail.com';
        $this->_subject = '产品付款';
    ...
    function createUrl($order, $httpHost, $subject = null, $body = null)
    {
        if(is_null($subject)) {
        ...
        $parameter = array(
            ...
            "payment_type" => "1",
            "quantity" => "1",
            "show_url" => "http://".$httpHost."/user/order-list/id/".$order->id,
            
            "receive_name" => 'Gavin',
            "receive_address" => '湖北武汉和平大道666号',    
            "receive_zip" => '430000',          
            "receive_mobile" => '18627873349',  
            "receive_phone" => '027-89089098',
