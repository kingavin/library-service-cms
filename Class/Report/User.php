<?php
    class Class_Report_User extends Class_Report_Abstract 
    {     
        function report()
        {
            $option="";
            ...
            $where=array();
            if($this->userId!='') $where[] = " user.id=".intval($this->userId);
            if($this->email!='') $where[] = " user.email='".$this->email."'";
            ...
            $query = "  select orders_item.productId, 
        							...
        							left join user on user.id=orders.customerId
